...
(http://dev.plasmads.org).  The bug tracker offers a Web form which allows
...
`Register <http://dev.plasmads.org/register>`_ link in the navigation bar and
...
`New Ticket <http://dev.plasmads.org/newticket>`_ link in the sidebar to open
